...
public interface AuthService {
    ...
    // 이메일 인증번호 확인
    ResponseEntity<? super CheckCertificationResponseDto> checkCertification(FindIdRequestDto request);
    // 아이디 찾기 
    ResponseEntity<? super ResponseDto> findIdByEmail(String email);
    void sendCertificationEmail(EmailCertificationRequestDto request);
